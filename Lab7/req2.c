...
//     period = PWM_TIM1_Init(3800); // initializes timer 1 in PWM mode with 25 kHz frequency
...
void main()
{
    ...
    period = PWM_TIM4_Init(4000); // initializes timer 1 in PWM mode with 25 kHz frequency
    // sets timer 8 duty ratio to 200, non inverted signal, channel 4
    // starts timer 3 PWM generation to channel 2 and maps the output to PC7
    while (1)
    {
